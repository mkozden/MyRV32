...
lui t3, 0x80000
addi t3, t3, 4        # Load address of 'result' into t3 (0x8000_0004)
sw t2, 4(t3)          # Store t2 at t3+4 (0x8000_0008)
li t2,0xDEADBEEF
sw t2, 0(t3)
...
sb t5, 8(t3)          # Store the first 8-bits of the result back to the address in t3+8 (should be 0)
lh t6, 0(t3)          # Load the halfword from the address in t3 into t6 (should be 0xBEEF)
